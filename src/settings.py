...
neutral_usernames = [
    'commsec', 'aus_business', 'financialreview', '4corners', '7news', '9news',
    'brisbanetimes', '3novices', 'smh', 'sbs', 'theheraldsun', 'australian',
...
PTN_for = {
    ...
    'bhp' : re.compile('|'.join([
        '#gobhp', 'inspir', 'potential', 'innovat', 'women', 'woman', 'gender', 
        'leadership', 'apprentice', 'productivity', 'health', 'efficien'
        ])),
    'santos' : re.compile('|'.join([
        '#gosantos', 'inspir', 'potential', 'innovat', 'women', 'woman', 'gender', 
        'leadership', 'apprentice', 'productivity', 'health', 'efficien'
        ])),
    'riotinto' : re.compile('|'.join([
        '#goriotinto', 'inspir', 'potential', 'innovat', 'women', 'woman', 'gender', 
        'leadership', 'apprentice', 'productivity', 'health', 'efficien'
        ])),
    'fortescue' : re.compile('|'.join([
        '#gofortescue', 'inspir', 'potential', 'innovat', 'women', 'woman', 'gender', 
        'leadership', 'apprentice', 'productivity', 'health', 'efficien'
        ]))
}
...
PTN_against = {
    ...
    'bhp' : re.compile('|'.join([
        '#stopbhp', 'protest', 'stopbhp', 'csg', 'nocoal', 'nonewcoal', 
        'climatechange', 'shenhua', 'caroona', 'risk'
        ])),
    'santos' : re.compile('|'.join([
        '#stopsantos', 'protest', 'csg', 'nocoal', 'nonewcoal', 
        'climatechange', 'risk'
        ])),
    'riotinto' : re.compile('|'.join([
        '#stopriotinto', 'protest', 'csg', 'nocoal', 'nonewcoal', 
        'climatechange', 'risk'
        ])),
    'fortescue' : re.compile('|'.join([
        '#stopfortescue', 'protest', 'csg', 'nocoal', 'nonewcoal', 
        'climatechange', 'risk'
        ]))
}
